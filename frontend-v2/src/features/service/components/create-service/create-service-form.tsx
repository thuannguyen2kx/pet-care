...
import type { TCreateServiceInput } from '@/features/service/schemas/create-service.schema';
...
type Props = {
  form: UseFormReturn<TCreateServiceInput>;
};
export function CreateServiceForm({ form }: Props) {
  return (
