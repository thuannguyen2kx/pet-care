...
import {
  presentService,
  type ServiceView,
} from '@/features/service/admin-app/service-list/dialog/service-detail/service-detail-precented';
...
function AdminServiceDetailContent({ service }: { service: ServiceView }) {
  return (
...
function ServiceImage({ images }: { images: Service['images'] }) {
  return (
    <div>
      {images.length > 0 ? (
