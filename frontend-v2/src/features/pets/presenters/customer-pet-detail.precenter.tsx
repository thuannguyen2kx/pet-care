import { PetSumary } from '@/features/pets/components/pet-sumary/pet-sumary';
import { PetHealthTab } from '@/features/pets/components/pet-tabs/pet-heath-tab';
import { PetHistoryTab } from '@/features/pets/components/pet-tabs/pet-history-tab';
import { PetVaccineTab } from '@/features/pets/components/pet-tabs/pet-vaccine-tab';
...
export function CustomerPetDetailPrecenter({ pet, onDelete }: Props) {
  return (
    <main className="container mx-auto px-4 py-6">
      <BackLink to={paths.customer.pets.path} label="Quay lại danh sách" />
      <div className="grid gap-6 lg:grid-cols-3">
        <aside className="lg:col-span-1">
          <PetSumary pet={pet} onDelete={onDelete} />
        </aside>
