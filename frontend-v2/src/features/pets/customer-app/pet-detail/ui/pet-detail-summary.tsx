...
import { formatGender, getPetTypeConfig } from '@/features/pets/config';
import { UpdatePetImageDialog } from '@/features/pets/customer-app/pet-detail/dialog/update-pet-image';
import { UpdatePetInfoDialog } from '@/features/pets/customer-app/pet-detail/dialog/update-pet-info/update-pet-info-dialog';
import { DeletePetButton } from '@/features/pets/customer-app/pet-detail/ui/delete-pet.button';
...
export function PetDetailSumary({ pet, onDelete }: Props) {
  const { label, icon: Icon } = getPetTypeConfig(pet.type);
  return (
    <Card className="overflow-hidden rounded-none border-none shadow-none">
      <div className="relative aspect-square">
        ...
        <div className="absolute right-4 bottom-4 left-4">
          <div className="flex justify-between">
            ...
            <UpdatePetImageDialog petId={pet.id} petImage={pet.image ?? undefined} />
          </div>
        </div>
      </div>
      ...
      <CardContent className="space-y-4 p-4">
        ...
        <div className="flex gap-2">
          ...
          <UpdatePetInfoDialog key={pet.id} pet={pet} />
        </div>
