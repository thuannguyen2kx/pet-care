...
import { useAdminMyPostsController } from '@/features/post/admin-app/post-list/application/use-my-posts';
...
export function AdminMyPostsWidget() {
  const postsController = useAdminMyPostsController();
    ...
    return (
      <div className="py-16 text-center">
        <div className="mb-4">
          ...
          <p className="text-muted-foreground">Hãy chia sẽ tin tức với khách hàng!</p>
        </div>
      </div>
    );
