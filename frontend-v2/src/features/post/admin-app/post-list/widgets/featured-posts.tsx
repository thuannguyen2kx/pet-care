...
import { useAdminFeaturedPostsController } from '@/features/post/admin-app/post-list/application/use-featured-posts';
...
export function FeaturedPostsWidget() {
  const postsController = useAdminFeaturedPostsController();
