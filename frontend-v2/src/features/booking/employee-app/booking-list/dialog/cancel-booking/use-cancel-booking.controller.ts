...
import { useEmployeeCancelBooking } from '@/features/booking/api/cancel-booking';
import { cancelBookingSchema, type CancelBooking } from '@/features/booking/domain/booking.state';

export const useEmployeeCancelBookingController = () => {
  ...
  const cancelBookingMutation = useEmployeeCancelBooking();
