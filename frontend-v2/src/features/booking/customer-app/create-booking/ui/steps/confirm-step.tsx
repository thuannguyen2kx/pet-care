...
type Props = {
  summary: ReturnType<typeof useBookingSummary>;
...
function ConfirmSummary({ summary }: { summary: ReturnType<typeof useBookingSummary> }) {
  ...
  return (
    <div className="bg-secondary/30 space-y-4 p-5">
      <div className="flex items-center gap-4">
        ...
        <p className="text-primary font-semibold">{totalAmount}</p>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-primary text-sm">
            {startTime} - {service.duration} phút
          </p>
        </div>
      </div>
