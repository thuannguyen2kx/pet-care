...
import { useAdminUpdateBookingStatus } from '@/features/booking/api/update-booking-status';
...
export const useUpdateBookingStatusController = () => {
  ...
  const openUpdateBookingStatusDialog = (bookingId: string, status: BookingStatus) => {
