...
import { Calendar, CheckCircle2, Clock, MoreVertical, PlayCircle, XCircle } from 'lucide-react';
...
export function BookingListContent({ bookings, isLoading }: Props) {
  if (isLoading) {
    ...
    <div className="space-y-3">
      ...
      {bookings.map((booking) => {
        ...
        return (
          <Link
            key={booking.id}
            to={paths.admin.bookingDetail.getHref(booking.id)}
            className="block"
          >
