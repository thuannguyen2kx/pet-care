...
import { EmployeeHeader } from '@/features/employee-schedule/components/schedule-detail-drawer/emplyee-header';
import { BreakTemplateTab } from '@/features/employee-schedule/components/schedule-detail-drawer/schedule-tabs/break-template-tab';
import { ShiftOverrideTab } from '@/features/employee-schedule/components/schedule-detail-drawer/schedule-tabs/shift-override-tab';
import { WeeklyShiftTab } from '@/features/employee-schedule/components/schedule-detail-drawer/schedule-tabs/weekly-shift-tabs';
...
export function ScheduleDetailDrawer({ open, onOpenChange, emloyeeId }: Props) {
  ...
  const handleDisableShiftTemplate = (shiftId: string) => {
    disableShiftTemplate.mutate({
      shiftId: shiftId,
      payload: {
            ...
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as TabValue)}>
              ...
              <TabsContent value="shifts">
                <WeeklyShiftTab
                  ...
                  onDiable={handleDisableShiftTemplate}
