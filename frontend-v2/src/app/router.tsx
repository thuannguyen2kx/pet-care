              ...
              children: [
                {
                  ...
                  children: [
                    ...
                    {
                      path: paths.customer.myBookings.path,
                      lazy: () =>
                        import('@/routes/customer/bookings/my-bookings').then(convert(queryClient)),
                    },
                    {
                      path: paths.customer.bookingDetail.path,
                      lazy: () =>
                        import('@/routes/customer/bookings/booking-details').then(
                          convert(queryClient),
                        ),
                    },
                    {
              ...
              children: [
                {
                  ...
                  children: [
                    ...
                    {
                      path: paths.admin.customer.path,
                      lazy: () => import('@/routes/admin/customers').then(convert(queryClient)),
                    },
                    {
                      path: 'services',
