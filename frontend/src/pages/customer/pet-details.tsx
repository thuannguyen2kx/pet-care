...
import { EditPetSheet } from "@/features/pet/components/edit-pet-sheet";
  ...
  return (
    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mt-1 grid grid-cols-1 md:grid-cols-2 gap-1 text-sm">
                          ...
                          {vaccination.expiryDate && (
                            <div className="flex items-center gap-1 text-gray-600">
                              <Calendar className="h-4 w-4" />
                              <span>
                                Hết hạn: {formatDate(vaccination.expiryDate)}
                              </span>
                            </div>
                          )}
      ...
      <EditPetSheet
        ...
        onOpenChange={setIsEditPetSheetOpen}
      />
    </div>
  );
};
